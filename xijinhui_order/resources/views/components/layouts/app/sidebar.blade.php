...
<flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
    ...
    {{-- <div class="relative"> --}}
    {{--     <!-- Cart icon (you can use Heroicons, FontAwesome, etc.) --> --}}
    ...
    {{--     <!-- Badge --> --}}
    {{--     <span --}}
    {{--         class="absolute -top-1 -right-1 bg-red-600 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">3</span> --}}
    {{-- </div> --}}
</flux:sidebar>
